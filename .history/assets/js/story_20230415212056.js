...
function loadStory() {
    ...
    for (let i = 0; i < Object.keys(element.choices).length; i++) {
        const data = element.line.content;
        console.log(choice);

        const template = `<div class="story-content-item">
        <div class="story-content-item__img">
            <img
                src="https://stories-cdn.duolingo.com/image/b45a7c3d4f4fbf70ab449735041183de0b14e515.svg"
                alt="story"
            />
        </div>
