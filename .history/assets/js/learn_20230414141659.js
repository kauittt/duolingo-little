...
closeBtn.addEventListener("click", function (e) {
    ...
    console.log(next);
    console.log(!next.classList.contains("learn-content__input"));
    if (!next.classList.contains("learn-content__input")) {
        ...
        if (JSON.stringify(answer) == JSON.stringify(key)) {
            ...
            if (
                !heading.nextElementSibling.classList.contains(
                    "learn-content__input"
                )
            )
                heading.nextElementSibling.parentNode.removeChild(
...
function loadListen(data, len, thumb = true) {
    ...
    heading.insertAdjacentHTML(
        "afterend",
        `<div class="learn-content__speaker">
