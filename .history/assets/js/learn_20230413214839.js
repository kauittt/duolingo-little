...
function loadListen(data, len, thumb = true) {
    ...
    <p class="learn-content__character__message learn-content__character__message--correct=${data.correctIndices}">
        ${data.prompt}
    </p>
</div>`
    );
    ...
    console.log(
        document
            .querySelector(".learn-content__character__message--correct")
            .getAttribute("learn-content__character__message--correct")
    );
