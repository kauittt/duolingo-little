...
document.body.addEventListener("click", function (e) {
    if (e.target.closest(".learn-content-item--listen")) {
        ...
        if (item.classList.contains("learn-content-item--selected")) {
            ...
            console.log(answer.slice(0, answer.indexOf(+item.dataset.id)));
            console.log(answer.slice(answer.indexOf(+item.dataset.id + 1), -1));
            // [0, 1, 2, 3, 4, 5];
            // answer = [
            //     ...answer.slice(0, answer.indexOf(+item.dataset.id)),
            //     ...answer.slice(answer.indexOf(+item.dataset.id), -1),
            // ];
        } else {
