...
console.log(data);
console.log(data.items[0].choices.length);
if (data && data.items && data.items[0] && data.items[0].choices) {
    console.log(data.items[0].choices.length);
} else {
...
function loadSurvey() {
    ...
    for (let i = 0; i < 8; i++) {
        //!
        const choice = data.items[0].choices[i];
        console.log(choice);
